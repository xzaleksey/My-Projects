...
public class Task {
    ...
    public Task(long id, String name, DateTime dateCreated, DateTime dateNotification, int order, Plan plan, Period period, boolean done, boolean disposable, int priority) {
        this.name = name;
        this.id = id;
